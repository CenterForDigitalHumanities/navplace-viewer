                    ...
                    .map(canvas => {
                        ...
                        if(canvas.navPlace.features){
                            canvas.navPlace.features.forEach(feature => {
                                ...
                                if (!feature.properties.hasOwnProperty("requiredStatement")) { feature.properties.requiredStatement = VIEWER.resource.requiredStatement ?? "" }
                                if (!feature.properties.hasOwnProperty("rights")) { feature.properties.rights = VIEWER.resource.rights ?? "" }
